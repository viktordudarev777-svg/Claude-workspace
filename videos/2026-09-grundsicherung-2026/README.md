> **СТАТУС: НЕ ДОПУЩЕН К ПУБЛИКАЦИИ.** Ни одно утверждение не подтверждено текстом закона.
> Что нужно проверить и что исправить — в [VERIFY.md](VERIFY.md).
...
Стоковые материалы не использовались, визуал целиком CSS/SVG, музыка синтезирована.
По лицензии синтезированного голоса вопрос не закрыт — см. VERIFY.md.
